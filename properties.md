| properties | description | mem bank | 
| :--- | :---: | ---: |
...
| oemGtin | GTIN of the | luminary |
| Property | "OEM GTIN" in PC-Tool | 1 |
...
| nominalInputPower | Nominal input power [W| ] |
| Property | "Nominal input power" in PC-Tool | 1 |
...
| colourRenderingIndex | Color rendering index of the | light |
| Property | "Color rendering index " in PC-Tool | 1 |
| colourTemperature | Color temperature of the light [K| ] |
| Property | "Color temperature" in PC-Tool | 1 |
| lightDistributionType | Light distribution type (type I...type V) | 1 |
| luminaireColor | Color as string | 1 |
| luminaireIdentification | Luminaire identification | string |
| ratedMedianUsefullLifeOfLuminaire | Rated median useful lifetime in | hour |
| internalControlGearReferenceTemperature | Reference  temperature  on  the  device  for  25  °C| | ambient temperature | 207 |
| ratedMedianUsefulLightSourceStarts | Rated median lamp switch on actions | 207 |